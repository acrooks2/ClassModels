...
to setup-gis
  ...
  set county-dataset gis:load-dataset "Mapdata/OrangeCountyBorder.shp"
  set results-dataset gis:load-dataset "OrangeCounty2016Results.shp"
  set pop-dataset gis:load-dataset "Population2017.shp"

  if district-choice = 2009 [
    set district-dataset gis:load-dataset "OrangeCountyDistricts2009.shp"
  ]
  if district-choice = 2011 [
    set district-dataset gis:load-dataset "OrangeCountyDistricts2011.shp"
  ]
